...
// ScanMap returns the result in the form of []map[string]any
...
// ScanMapDecode returns the result in the form of []map[string]any
...
// ScanMapDecodeClose returns the result in the form of []map[string]any
// If possible, it will convert []uint8 to int or float64, or it will convert
