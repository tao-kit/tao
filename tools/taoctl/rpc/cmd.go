...
import (
	...
	"manlu.org/tao/tools/taoctl/rpc/cli"
)
...
func init() {
	...
	Cmd.Flags().StringVar(&cli.VarStringHome, "home", "", "The taoctl home path of the template, --home and --remote cannot be set at the same time, if they are, --remote has higher priority")
	...
	newCmd.Flags().StringVar(&cli.VarStringStyle, "style", "gotao", "The file naming format, see [https://manlu.org/tao/tree/master/tools/taoctl/config/readme.md]")
	newCmd.Flags().BoolVar(&cli.VarBoolIdea, "idea", false, "Whether the command execution environment is from idea plugin.")
	newCmd.Flags().StringVar(&cli.VarStringHome, "home", "", "The taoctl home path of the template, "+
	...
	newCmd.Flags().StringVar(&cli.VarStringRemote, "remote", "", "The remote git repo of the template, "+
		"--home and --remote cannot be set at the same time, if they are, --remote has higher priority\n\tThe git repo "+
		"directory must be consistent with the https://manlu.org/tao-template directory structure")
	...
	protocCmd.Flags().StringVar(&cli.VarStringStyle, "style", "gotao", "The file naming format, see [https://manlu.org/tao/tree/master/tools/taoctl/config/readme.md]")
	protocCmd.Flags().StringVar(&cli.VarStringHome, "home", "", "The taoctl home path of the template, "+
		"--home and --remote cannot be set at the same time, if they are, --remote has higher priority")
	...
	templateCmd.Flags().StringVar(&cli.VarStringHome, "home", "", "The taoctl home path of the template, --home and --remote cannot be set at the same time, if they are, --remote has higher priority")
