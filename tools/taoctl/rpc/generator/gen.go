...
func (g *RPCGenerator) Generate(src, target string, protoImportPath []string, validate bool, goOptions ...string) error {
	...
	err = g.g.GenPb(dirCtx, protoImportPath, proto, g.cfg, validate, goOptions...)
	if err != nil {
		return err
	}
