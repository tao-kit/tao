...
var (
	...
	newCmd = &cobra.Command{
		...
		Example: "taoctl api new [options] service-name",
...
func init() {
	...
	Cmd.Flags().StringVar(&apigen.VarStringHome, "home", "", "The taoctl home path of the"+
	...
	goCmd.Flags().StringVar(&gogen.VarStringHome, "home", "", "The taoctl home path of "+
	...
	newCmd.Flags().StringVar(&new.VarStringHome, "home", "", "The taoctl home path of "+
		"the template, --home and --remote cannot be set at the same time, if they are, --remote "+
		"has higher priority")
