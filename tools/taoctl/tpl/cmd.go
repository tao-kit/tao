...
func init() {
	initCmd.Flags().StringVar(&varStringHome, "home", "", "The taoctl home path of the template")
	cleanCmd.Flags().StringVar(&varStringHome, "home", "", "The taoctl home path of the template")
	updateCmd.Flags().StringVar(&varStringHome, "home", "", "The taoctl home path of the template")
	updateCmd.Flags().StringVarP(&varStringCategory, "category", "c", "", "The category of template, enum [api,rpc,model,docker,kube]")
	revertCmd.Flags().StringVar(&varStringHome, "home", "", "The taoctl home path of the template")
