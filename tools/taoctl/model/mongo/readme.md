...
```bash
$ taoctl model mongo -t User -c --dir .
```
...
Flags:
  ...
  -h, --help            help for mongo
      ...
      --style string    The file naming format, see [https://github.com/sllt/tao/tree/master/tools/taoctl/config/readme.md]
