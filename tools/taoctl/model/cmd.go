...
import (
	...
	"manlu.org/tao/tools/taoctl/model/sql/command"
)
...
func init() {
	...
	ddlCmd.Flags().StringVar(&command.VarStringStyle, "style", "", "The file naming format, see [https://manlu.org/tao/tree/master/tools/taoctl/config/readme.md]")
	...
	datasourceCmd.Flags().StringVar(&command.VarStringStyle, "style", "", "The file naming format, see [https://manlu.org/tao/tree/master/tools/taoctl/config/readme.md]")
	...
	pgCmd.Flags().StringVar(&command.VarStringStyle, "style", "", "The file naming format, see [https://manlu.org/tao/tree/master/tools/taoctl/config/readme.md]")
	pgCmd.Flags().BoolVar(&command.VarBoolIdea, "idea", false, "For idea plugin [optional]")
	pgCmd.Flags().StringVar(&command.VarStringHome, "home", "", "The taoctl home path of the template, --home and --remote cannot be set at the same time, if they are, --remote has higher priority")
	...
	mongoCmd.Flags().StringVar(&mongo.VarStringStyle, "style", "", "The file naming format, see [https://manlu.org/tao/tree/master/tools/taoctl/config/readme.md]")
