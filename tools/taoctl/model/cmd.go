...
import (
	...
	"github.com/sllt/tao/tools/taoctl/model/mongo"
	"github.com/sllt/tao/tools/taoctl/model/sql/command"
)
...
func init() {
	...
	ddlCmd.Flags().StringVar(&command.VarStringStyle, "style", "", "The file naming format, see [https://github.com/sllt/tao/tree/master/tools/taoctl/config/readme.md]")
	...
	ddlCmd.Flags().StringVar(&command.VarStringHome, "home", "", "The taoctl home path of the template, --home and --remote cannot be set at the same time, if they are, --remote has higher priority")
	ddlCmd.Flags().StringVar(&command.VarStringRemote, "remote", "", "The remote git repo of the template, --home and --remote cannot be set at the same time, if they are, --remote has higher priority\nThe git repo directory must be consistent with the https://github.com/sllt/tao-template directory structure")
	...
	datasourceCmd.Flags().StringVar(&command.VarStringStyle, "style", "", "The file naming format, see [https://github.com/sllt/tao/tree/master/tools/taoctl/config/readme.md]")
	datasourceCmd.Flags().BoolVar(&command.VarBoolIdea, "idea", false, "For idea plugin [optional]")
	datasourceCmd.Flags().StringVar(&command.VarStringHome, "home", "", "The taoctl home path of the template, --home and --remote cannot be set at the same time, if they are, --remote has higher priority")
	...
	pgDatasourceCmd.Flags().StringVar(&command.VarStringStyle, "style", "", "The file naming format, see [https://github.com/sllt/tao/tree/master/tools/taoctl/config/readme.md]")
	...
	pgDatasourceCmd.Flags().StringVar(&command.VarStringHome, "home", "", "The taoctl home path of the template, --home and --remote cannot be set at the same time, if they are, --remote has higher priority")
	...
	mongoCmd.Flags().StringVar(&mongo.VarStringStyle, "style", "", "The file naming format, see [https://github.com/sllt/tao/tree/master/tools/taoctl/config/readme.md]")
	mongoCmd.Flags().StringVar(&mongo.VarStringHome, "home", "", "The taoctl home path of the template, --home and --remote cannot be set at the same time, if they are, --remote has higher priority")
