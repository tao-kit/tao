...
func init() {
	...
	Cmd.Flags().StringVar(&varStringHome, "home", "", "The taoctl home path of the template, --home and --remote cannot be set at the same time, if they are, --remote has higher priority")
	...
	Cmd.Flags().StringVar(&varStringVersion, "version", "", "The taoctl builder golang image version")
